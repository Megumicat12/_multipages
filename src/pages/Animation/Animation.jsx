  ...
  const getBallStyle = () => {
    ...
    switch (ballType) {
      case "basketball":
        return {
          ...baseStyle,
          backgroundImage: "url('./picBall/basketball.jpg')",
        };
      case "football":
        return {
          ...baseStyle,
          backgroundImage: "url('./picBall/football_.jpg')",
        };
      case "volleyball":
        return {
          ...baseStyle,
          backgroundImage: "url('./picBall/valleyball.png')",
          backgroundSize: "165%",
        };
      case "human":
        return {
          ...baseStyle,
          backgroundImage: "url('./picBall/humen.jpg')",
        };
      case "cartoon":
        return {
          ...baseStyle,
          backgroundImage: "url('./picBall/cartoon.jpg)",
        };
      case "logo":
        return {
          ...baseStyle,
          backgroundImage: "url(./picBall/fox.jpg')",
        };
      default:
        return {
          ...baseStyle,
